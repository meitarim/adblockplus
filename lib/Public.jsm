...
/**
 * @fileOverview Public Ad Blocking Community API.
 */
...
/**
 * Class implementing public Ad Blocking Community API
 * @class
 */
var AdblockPlus =
{
  ...
  /**
   * Returns installed Ad Blocking Community version
   */
  ...
  /**
   * Returns source code revision this Ad Blocking Community build was created from (if available)
   */
