...
let FilterStorage = exports.FilterStorage =
{
  ...
  get sourceFile()
  {
    ...
    if (!file)
      Cu.reportError("Community Adblock: Failed to resolve filter file location from extensions.adblockplus.patternsfile preference");
  ...
  {
    yield "# Community Adblock preferences";
