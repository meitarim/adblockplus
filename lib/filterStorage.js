...
let FilterStorage = exports.FilterStorage =
{
  ...
  get sourceFile()
  {
    ...
    if (!file)
      Cu.reportError("Ad Blocking Community: Failed to resolve filter file location from extensions.adblockplus.patternsfile preference");
  ...
  {
    yield "# Ad Blocking Community preferences";
