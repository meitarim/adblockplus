...
DownloadableSubscription.prototype =
{
   ...
   * if the user doesn't use Ad Blocking Community for some time.
   * @type Number
   */
  get lastCheck()
  {
  ...
  /**
   * Minimal Ad Blocking Community version required for this subscription
   * @type String
   */
  requiredVersion: null,

  /**
   * Should be true if requiredVersion is higher than current Ad Blocking Community version
   * @type Boolean
   */
