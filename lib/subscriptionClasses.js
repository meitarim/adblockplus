...
DownloadableSubscription.prototype =
{
   ...
   * if the user doesn't use Adblocky for some time.
   * @type Number
   */
  get lastCheck()
  {
  ...
  /**
   * Minimal Adblocky version required for this subscription
   * @type String
   */
  requiredVersion: null,

  /**
   * Should be true if requiredVersion is higher than current Adblocky version
   * @type Boolean
   */
