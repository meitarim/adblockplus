...
DownloadableSubscription.prototype =
{
   ...
   * if the user doesn't use Community Adblock for some time.
   * @type Number
   */
  get lastCheck()
  {
  ...
  /**
   * Minimal Community Adblock version required for this subscription
   * @type String
   */
  requiredVersion: null,

  /**
   * Should be true if requiredVersion is higher than current Community Adblock version
   * @type Boolean
   */
