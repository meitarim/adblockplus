...
let UI = exports.UI =
{
  ...
  /**
   * Gets called once the initialization is finished and Adblocky elements
  ...
  /**
   * Initializes Adblocky UI in a window.
   */
  ...
  /**
   * Removes Adblocky UI from a window.
   */
  ...
  /**
   * Iterator for application windows that Adblocky should apply to.
   * @type Iterator
   */
  ...
  /**
   * Updates Adblocky icon state for all windows.
   */
  ...
  /**
   * Updates Adblocky icon state for a single application window.
   */
  ...
  /**
   * Toggles the pref for the Adblocky sync engine.
  ...
  /**
   * Adds Adblocky menu items to the content area context menu when it shows
   * up.
   */
