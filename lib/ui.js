...
let UI = exports.UI =
{
  ...
  /**
   * Gets called once the initialization is finished and Community Adblock elements
  ...
  /**
   * Initializes Community Adblock UI in a window.
   */
  ...
  /**
   * Removes Community Adblock UI from a window.
   */
  ...
  /**
   * Iterator for application windows that Community Adblock should apply to.
   * @type Iterator
   */
  ...
  /**
   * Updates Community Adblock icon state for all windows.
   */
  ...
  /**
   * Updates Community Adblock icon state for a single application window.
   */
  ...
  /**
   * Toggles the pref for the Community Adblock sync engine.
   ...
   * pop-ups related to Community Adblock.
   */
  ...
  /**
   * Adds Community Adblock menu items to the content area context menu when it shows
   * up.
   */
