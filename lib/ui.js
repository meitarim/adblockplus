...
let UI = exports.UI =
{
  ...
  /**
   * Gets called once the initialization is finished and Ad Blocking Community elements
  ...
  /**
   * Initializes Ad Blocking Community UI in a window.
   */
  ...
  /**
   * Removes Ad Blocking Community UI from a window.
   */
  ...
  /**
   * Iterator for application windows that Ad Blocking Community should apply to.
   * @type Iterator
   */
  ...
  /**
   * Updates Ad Blocking Community icon state for all windows.
   */
  ...
  /**
   * Updates Ad Blocking Community icon state for a single application window.
   */
  ...
  /**
   * Toggles the pref for the Ad Blocking Community sync engine.
   ...
   * pop-ups related to Ad Blocking Community.
   */
  ...
  /**
   * Adds Ad Blocking Community menu items to the content area context menu when it shows
   * up.
   */
